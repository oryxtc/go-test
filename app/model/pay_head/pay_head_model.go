...
// arModel is a active record design model for table pay_head operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pay_head.
	Table = "pay_head"
	// Model is the model object of pay_head.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pay_head.
	Columns = struct {
		Id                string //                                              
        Vid               string // id                                           
        PayId             string // id                                           
        ItAmount          string // 结算单金额-预付款金额                        
        Status            string // 2-待确认, 3-已确认,待审核,4-待付款,5-已付款  
        DueDate           string // 账期到期日 = 结算单生成日期+账期天数         
        ApproveUid        string // id                                           
        ApproveUsername   string // 审核人                                       
        ApproveDate       string // 审核日期                                     
        IssueUid          string // id                                           
        IssueUsername     string //                                              
        IssueDate         string //                                              
        ModifiedUid       string // 修改人id                                     
        ModifiedUsername  string // 修改人                                       
        ModifiedDate      string // 修改时间                                     
        CompanyId         string // 支付单生成时供商的结算公司                   
        Type              string // 支付单类型：1-正常；2-预付款支付单           
        Comment           string // 备注                                         
        IsDeleted         string // 是否已删除，0-未删除，1-已删除               
        CreatedAt         string //                                              
        UpdatedAt         string //                                              
        VenderId          string // 租户id/商家id
	}{
		Id:               "id",                 
        Vid:              "vid",                
        PayId:            "pay_id",             
        ...
        Status:           "status",             
        DueDate:          "due_date",           
        ApproveUid:       "approve_uid",        
        ApproveUsername:  "approve_username",   
        ApproveDate:      "approve_date",       
        IssueUid:         "issue_uid",          
        IssueUsername:    "issue_username",     
        IssueDate:        "issue_date",         
        ModifiedUid:      "modified_uid",       
        ModifiedUsername: "modified_username",  
